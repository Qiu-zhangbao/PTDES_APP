...
#define TOUCH_AD_LEFT 		3990		//按下触摸屏的左侧，写下 X 轴模拟输入值。
#define TOUCH_AD_RIGHT		160	//按下触摸屏的右侧，写下 X 轴模拟输入值。
...
void LCD_X_Config(void) {
	...
	}else if(lcddev.id == 0X5310 || lcddev.id == 0X6804 || lcddev.id == 0X9486) //0X5510 0X6804为3.5寸 320x480
	{
		if(lcddev.dir == 0) //竖屏 	
		{							
