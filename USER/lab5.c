...
{	
	Bsl_CreateScreen(Fun_lab5_page_Screen,SCREEN_TYPE_MAIN,SCREEN_PRI_HEIGH);
	resgister_event_handle(Fun_lab5_page_Handle,EVENT_KEY0_PRESSED);
}
...
{
	Bsl_WakeupScreen(5);
	Bsl_ShowScreen(Fun_lab5_page_Screen,0);
}

void Fun_Close_lab5_page(void)
{
	Bsl_WakeupScreen(5);
	Bsl_CloseScreen(Fun_lab5_page_Screen);
}
